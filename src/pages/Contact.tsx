      ...
      <section className="py-24 px-6 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20">
        ...
        <div className="space-y-12">
          <div className="space-y-4">
            <h2 className="text-3xl font-serif font-bold text-tea-primary">Thông tin liên hệ</h2>
          ...
          <div className="space-y-8">
            <div className="flex items-start gap-6 p-8 rounded-3xl bg-white border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-500">
              <div className="p-4 rounded-2xl bg-tea-primary/5 text-tea-primary">
                <MapPin size={24} />
              </div>
              <div className="space-y-1">
                <p className="text-xs font-bold text-gray-400 uppercase tracking-widest">Địa chỉ</p>
                <p className="text-lg font-bold text-tea-primary">123 Tân Cương, Thái Nguyên, Việt Nam</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-6 p-8 rounded-3xl bg-white border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-500">
              ...
              <div className="space-y-1">
                ...
                <p className="text-lg font-bold text-tea-primary">0898992654</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-6 p-8 rounded-3xl bg-white border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-500">
              ...
              <div className="space-y-1">
                ...
                <p className="text-lg font-bold text-tea-primary">contact@traviet.com</p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white p-10 md:p-12 rounded-[40px] shadow-2xl border border-gray-100">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold text-tea-primary uppercase tracking-widest">Chủ đề</label>
              <select className="w-full bg-gray-50 border border-gray-200 rounded-2xl px-6 py-4 focus:outline-none focus:border-tea-primary transition-colors">
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold text-tea-primary uppercase tracking-widest">Tin nhắn</label>
              <textarea
                required
                rows={5}
        ...
        <div className="max-w-7xl mx-auto h-[500px] rounded-[40px] overflow-hidden shadow-xl border border-gray-100 bg-gray-100 relative">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="bg-white p-6 rounded-3xl shadow-2xl border border-gray-100 text-center space-y-2">
              <MapPin className="mx-auto text-tea-primary" size={32} />
              <p className="font-bold text-tea-primary">TRÀ VIỆT SHOWROOM</p>
